...
public class NewCustomer extends JFrame {
    ...
    NewCustomer() throws SQLException {
	...
	contentPane.setLayout(null);
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Images/fifth.jpg"));
	...
	comboBox.setBounds(100, 73, 150, 20);
	...
	contentPane.add(l2);
        ...
        t1 = new JTextField();
	t1.setBounds(100, 111, 150, 20);
	contentPane.add(t1);
	t1.setColumns(10);
        
        JLabel lblName_1 = new JLabel("Name :");
	lblName_1.setBounds(35, 151, 200, 14);
        lblName_1.setFont(new Font("arial", Font.PLAIN, 14));
	contentPane.add(lblName_1);
		
	t2 = new JTextField();
	t2.setBounds(100, 151, 150, 20);
	contentPane.add(t2);
	t2.setColumns(10);
	...
	contentPane.add(lblGender);
        ...
        r1.setBounds(100, 191, 80, 12);
        add(r1);
        
        r2 = new JRadioButton("Female");
        r2.setFont(new Font("Raleway", Font.BOLD, 14));
        r2.setBackground(Color.WHITE);
        r2.setBounds(190, 191, 100, 12);
	add(r2);
	...
	lblReserveRoomNumber.setBounds(35, 274, 200, 14);
        lblReserveRoomNumber.setFont(new Font("arial", Font.PLAIN, 14));
	contentPane.add(lblReserveRoomNumber);
        ...
        try{
            ...
            ResultSet rs = connection.s.executeQuery("select * from room");
